...
type mainModel struct {
	state   sessionState  // sessionState is used to track which model is focused
	timer   timer.Model   // timer
	spinner spinner.Model // spinner
	index   int
}

func newModel(timeout time.Duration) *mainModel {
	m := &mainModel{state: timerView} // default focused model is timer
